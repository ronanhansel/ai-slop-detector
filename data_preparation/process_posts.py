...
def process_posts_Empath(json_file_path: str, output_csv_path: str) -> None:
    """
    ...
    for post_id, post in enumerate(data, start=1):
        ...
        # Clean content
        processed_content = clean_text_for_posts_Empath(original_content, author=username)
...
def process_all_posts_Empath(input_dir: str, output_csv_path: str) -> None:
    """
...
def process_posts_LSA(json_file_path: str, output_csv_path: str) -> None:
    """
    Process posts from a JSON file and save to CSV.
    ...
    for post_id, post in enumerate(data, start=1):
        ...
        # Clean content
        processed_content = clean_text_for_posts_LSA(original_content, author=username)
...
def process_all_posts_LSA(input_dir: str, output_csv_path: str) -> None:
    """
    Process all post JSON files in a directory.
